          ...
          <ul class="nav navbar-nav">
            ...
            <center>
              <div style="width:25%; padding-top:5%;">
                <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='#'" >Change I</a></button><br>
                <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='#'">Change II</button><br>
                <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='#'">Change III</button><br>
                <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='#'">Change IV</button><br>
                <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='#'">Change V</button><br></div>
              </center>
